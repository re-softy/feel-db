        ...
        <div className="w-full flex flex-col rounded-lg p-4 border gap-y-3 border-[#262626]">
            <div className="gap-2 flex items-center">
                ...
                <div className="flex flex-col items-start justify-between">
                    <span className="text-md">Daduka Khukhunashvili</span>
                    <span className="text-sm text-gray-500">17 Aug 2024</span>
                </div>
            </div>
            ...
            <div className="flex items-center gap-x-2">
                ...
                <button className="focus:outline-none text-sm rounded-3xl px-4 py-2 bg-[#232323]">Replay</button>
            </div>
        </div>
    )
}
